  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        agneyDisplay: ["var(--font-agney-display)", "Space Grotesk", "Syne", "sans-serif"],
        agneyBody: ["var(--font-agney-body)", "Inter", "DM Sans", "sans-serif"],
      },
      fontSize: {
      ...
      boxShadow: {
        ...
        "agney-card": "0 4px 24px rgba(0,0,0,0.25)",
        "agney-card-hover": "0 16px 40px -10px rgba(0,0,0,0.5), 0 0 24px rgba(255, 69, 0, 0.2)",
        "agney-glow": "0 0 35px rgba(255, 69, 0, 0.40)",
        "agney-glow-sm": "0 0 15px rgba(255, 69, 0, 0.35)",
        "agney-glow-gold": "0 0 30px rgba(255, 180, 0, 0.30)",
      },
    },
  },
  plugins: [],
